...
#panjang weights sesuai dengan panjang input, dan jumlah weights sesuai harus sama dengan jumlah neuron
weights = [[0.4, 6.2, 4.0, 8.1, 3.6, 7.0, 5.8, 2.5, 2.1, 1.0],
